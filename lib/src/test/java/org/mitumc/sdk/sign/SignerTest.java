...
public class SignerTest {
    ...
    @DisplayName("Test signer - add multi sig")
    @Test
    void testMultiSig() {
        ...
        Signer signer3 = Signer.get("mitum", Keypair.random().getPrivateKey());
        Signer signer4 = Signer.get("mitum", Keypair.random().getPrivateKey());
        Signer signer5 = Signer.get("mitum", Keypair.random().getPrivateKey());
        Signer signer6 = Signer.get("mitum", Keypair.random().getPrivateKey());
        Signer signer7 = Signer.get("mitum", Keypair.random().getPrivateKey());
        Signer signer8 = Signer.get("mitum", Keypair.random().getPrivateKey());
        Signer signer9 = Signer.get("mitum", Keypair.random().getPrivateKey());

        JsonObject signed = JSONParser.getObjectFromJsonFile("../test-jsons/sample/create-accounts.json");

        signed = JSONParser.getObjectFromHashMap(signer0.addSignToOperation(signed));
        signed = JSONParser.getObjectFromHashMap(signer1.addSignToOperation(signed));
        signed = JSONParser.getObjectFromHashMap(signer2.addSignToOperation(signed));
        signed = JSONParser.getObjectFromHashMap(signer3.addSignToOperation(signed));
        signed = JSONParser.getObjectFromHashMap(signer4.addSignToOperation(signed));
        signed = JSONParser.getObjectFromHashMap(signer5.addSignToOperation(signed));
        signed = JSONParser.getObjectFromHashMap(signer6.addSignToOperation(signed));
        signed = JSONParser.getObjectFromHashMap(signer7.addSignToOperation(signed));
        signed = JSONParser.getObjectFromHashMap(signer8.addSignToOperation(signed));
        signed = JSONParser.getObjectFromHashMap(signer9.addSignToOperation(signed));

        JSONParser.writeJsonFileFromJsonObject(signed, "../test-jsons/test-result/multi-sig.json");
    }
}
