...
public class SingleDocument {
    ...
    public static LandDocument land(String documentId, String owner, String address, String area, String renter, String account, String rentDate, int period) {
        return new LandDocument(documentId, owner, address, area, renter, account, rentDate, period);
    }

    public static VoteDocument vote(String documentId, String owner, int round, String endTime, Candidate[] candidates, String bossName, String account, String office) {
        return new VoteDocument(documentId, owner, round, endTime, candidates, bossName, account, office);
    }

    public static HistoryDocument history(String documentId, String owner, String name, String account, String date, String usage, String app) {
