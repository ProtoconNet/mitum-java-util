...
Using BTC, ETHER keypair, adding fact signature to operation json files, and generating seal will be available later.
...
* 'network id' - now network id is fixed to 'mitum'. This will be flexible soon.
...
Setting 'network id' will be available later. 
...
'Generate New Seal' will be available in next update.
